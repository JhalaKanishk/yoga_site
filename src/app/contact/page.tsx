...
const handleSubmit = async (e: React.FormEvent) => {
  ...
  try {
    await emailjs.send(
      "service_7hocyqr",     // 👈 Your service ID
      "template_trqz4iy",    // 👈 Replace with your actual template ID
      {
        name: formData.name,
        email: formData.email,
        message: formData.message,
      },
      "FHumnDhm2Desf7bks"       // 👈 Replace with your actual public key from EmailJS
    );
    ...
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-white">
      ...
      <section className="py-16 px-4 bg-green-50">
        <div className="container mx-auto">
          ...
          <div className="bg-green-200 rounded-2xl h-96 overflow-hidden">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m21!1m12!1m3!1d15974.46749135528!2d73.66527515391495!3d24.581912724676634!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!4m6!3e6!4m0!4m3!3m2!1d24.581374410293524!2d73.67486102455904!5e0!3m2!1sen!2sin!4v1751982359600!5m2!1sen!2sin"
